...
<body>
	...
	<h1 class="text-center font-weight-bold">회원 정보 입력/수정</h1>
	<br>
	<form action="<%=action %>" method="post">
		<div class="form-group">
			<label for="id">아이디:</label>
			<input type="text" class="form-control" id="id" name="id" value="<%=id %>" <%=id != null ? "readonly" : "required" %>>
		</div>
		<div class="form-group">
		...
		<div class="text-center">
			<button type="submit" class="btn btn-primary"><%=id != null ? "수정하기" : "가입하기" %></button>
